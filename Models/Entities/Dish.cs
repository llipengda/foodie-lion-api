...
[EntityTypeConfiguration(typeof(DishConfiguration))]
public class Dish
{
    ...
    public void Update(UpdateDishParams updateParams)
    {
        if (!string.IsNullOrEmpty(updateParams.Name))
        {
            Name = updateParams.Name;
        }
        if (updateParams.Price != null)
        {
            Price = updateParams.Price.Value;
        }
        if (!string.IsNullOrEmpty(updateParams.Canteen))
        {
            Canteen = updateParams.Canteen;
        }
        if (!string.IsNullOrEmpty(updateParams.Window))
        {
            Window = updateParams.Window;
        }
